    ...
    div.report-item.full-container
        div.report-item__panel.position-relative.margin-bottom
            ...
            div.report-item__filter-panel
                ...
                el-button.filter-btn(type="primary" size="small" @click="search") 查询
    ...
    export default {
        ...
        methods: {
            ...
            getReport () {
                ...
                Api.get('app_active_user_count', paramsWithPage, true).then(res => {
                    // 搜索的添加到导出过滤项
            ...
            getSummaries () {
                ...
                Api.get('app_total_active_count', params, true).then(res => {
                    this.totalData = res
                    this.setSummary()
                })
            },
            ...
            exportReport () {
                Api.get('app_active_export', this.exportParams, true, 'blob').then(res => {
